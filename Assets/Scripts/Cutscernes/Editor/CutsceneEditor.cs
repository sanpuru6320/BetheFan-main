...
public class CutsceneEditor : Editor
{
    public override void OnInspectorGUI()//追加したいカットシーンの処理をここに追加
    {
        ...
        //using (var scope = new GUILayout.HorizontalScope())
        //{
        //    if (GUILayout.Button("NPC Event Interact"))
        //        cutscene.AddAction(new NPCEventDialogueAction());
        //    else if (GUILayout.Button("MutiDialogueEventAction"))
        //        cutscene.AddAction(new MutiDialogueEventAction());
        //    //else if (GUILayout.Button("Fade Out"))
        //    //    cutscene.AddAction(new FadeOutAction());
        //}
